...
def test_main_download_from_poly(
    ...
    assert NASASRTMUtil_mock.get_files.call_args[0][2] == 0
    assert NASASRTMUtil_mock.get_files.call_args[0][3] == 0
    assert NASASRTMUtil_mock.get_files.call_args[0][4] == ["view1"]
...
def test_main_manual_input_poly(
    ...
    # Check
    NASASRTMUtil_mock.get_files.assert_not_called()
